...
(function (window) {
    ...
    ***********************************************/
    ...
    window.kg.utils = {
        ...
        getTemplateText: function (tmplId) {
            var el = document.getElementById(tmplId);
            var doesExist = (el !== undefined && el !== null);
            if (!doesExist) {
    ...
    ***********************************************/
    ...
    //window.kg.defaultGridTemplate = function () { 
        ...
        //'<div class="kgGroupPanelDescription" data-bind="visible: configGroups().length == 0">Drag a column header here and drop it to group by that column</div><ul data-bind="visible: configGroups().length > 0, foreach: configGroups" class="kgGroupList"><li class="kgGroupItem"><span class="kgGroupElement"><div class="kgGroupName"><span data-bind="text: displayName"></span><span data-bind="click: function(data) { $root.removeGroup($index()) }" class="kgRemoveGroup">x</span></div><span data-bind="visible: $index() < ($root.configGroups().length - 1)" class="kgGroupArrow"></span></span></li></ul></div>'+
        //'<div class="kgHeaderContainer" data-bind="style: headerStyle"><div class="kgHeaderScroller" data-bind="style: headerScrollerStyle, kgHeaderRow: $data" ></div></div><div class="kgHeaderButton" data-bind="visible: ($data.showColumnMenu || $data.showFilter), click: toggleShowMenu"><div class="kgHeaderButtonArrow"></div></div><div data-bind="visible: showMenu" class="kgColMenu"><div data-bind="visible: showFilter"><input placeholder="Seach Field:Value" type="text" data-bind="value: filterText, valueUpdate: \'afterkeydown\'"/></div><div data-bind="visible: showColumnMenu"><span class="kgMenuText">Choose Columns:</span><ul class="kgColList" data-bind="foreach: nonAggColumns"><li class="kgColListItem"><label style="position: relative;"><input type="checkbox" class="kgColListCheckbox" data-bind="checked: visible"/><span data-bind="text: displayName, click: toggleVisible"></span><a title="Group By" data-bind="attr: {\'class\': groupedByClass }, visible: (field != \'\u2714\'), click: $parent.groupBy"></a><span class="kgGroupingNumber" data-bind="visible: groupIndex() > 0, text: groupIndex"></span></label></li></ul></div></div></div>'+
        //'<div class="kgViewport" data-bind="css: {\'ui-widget-content\': jqueryUITheme}, style: viewportStyle"><div class="kgCanvas" data-bind="style: canvasStyle"><div data-bind="foreach: renderedRows" style="position: absolute;"><div data-bind="style: { \'top\': offsetTop, \'height\': $parent.rowHeight + \'px\' }, click: toggleSelected, css: {\'selected\': selected, \'even\': isEven , \'odd\': isOdd, \'ui-state-default\': $parent.jqueryUITheme && isOdd, \'ui-state-active\':$parent.jqueryUITheme && isEven}, kgRow: $data" class="kgRow"></div></div></div></div><div class="kgFooterPanel" data-bind="visible: footerVisible, css: {\'ui-widget-content\': jqueryUITheme, \'ui-corner-bottom\': jqueryUITheme}, style: footerStyle"><div class="kgTotalSelectContainer" data-bind="visible: footerVisible"><div class="kgFooterTotalItems" data-bind="css: {\'kgNoMultiSelect\': !multiSelect}" ><span class="kgLabel">Total Items: <span data-bind="text: maxRowsDisplay"></span></span><span data-bind="visible: filterText().length > 0" class="kgLabel">(Showing: <span data-bind="text: totalFilteredItemsLength"></span>)</span></div><div class="kgFooterSelectedItems" data-bind="visible: multiSelect"><span class="kgLabel">Selected Items: <span data-bind="text: selectedItemCount"></span></span></div></div><div class="kgPagerContainer" style="float: right; margin-top: 10px;" data-bind="visible: (footerVisible && enablePaging), css: {\'kgNoMultiSelect\': !multiSelect}"><div style="float:left; margin-right: 10px;" class="kgRowCountPicker"></div><div style="float:left; margin-right: 10px; line-height:25px;" class="kgPagerControl" style="float: left; min-width: 135px;"><button class="kgPagerButton" data-bind="click: pageToFirst, disable: cantPageBackward()" title="First Page"><div class="kgPagerFirstTriangle"><div class="kgPagerFirstBar"></div></div></button><button class="kgPagerButton" data-bind="click: pageBackward, disable: cantPageBackward()" title="Previous Page"><div class="kgPagerFirstTriangle kgPagerPrevTriangle"></div></button><input class="kgPagerCurrent" type="number" style="width:50px; height: 24px; margin-top: 1px; padding: 0px 4px;" data-bind="value: pagingOptions.currentPage, valueUpdate: \'afterkeydown\'"/><button class="kgPagerButton" data-bind="click: pageForward, disable: cantPageForward()" title="Next Page"><div class="kgPagerLastTriangle kgPagerNextTriangle"></div></button><button class="kgPagerButton" data-bind="click: pageToLast, disable: cantPageForward()" title="Last Page"><div class="kgPagerLastTriangle"><div class="kgPagerLastBar"></div></div></button></div></div></div></div>'; };
    window.kg.defaultGridTemplate = function () {
        return '<div>'+
        '<div class="kgTopPanel">'+
        '<div class="kgHeaderContainer">'+
        '<table>'+
        //'<colgroup data-bind="foreach: visibleColumns"><col data-bind="attr: { \'class\': \'col\' + $index() }"/></colgroup>'+
        '<thead data-bind="kgHeaderRow: $data"></thead>'+
        '</table>'+
        '</div>'+
        '</div>'+
        '<div class="kgViewport">'+
        '<table>'+
        //'<colgroup data-bind="foreach: visibleColumns"><col data-bind="attr: { \'class\': \'col\' + $index() }"/></colgroup>'+
        '<!-- ko foreach: renderedRows -->'+
        '<tbody data-bind="kgRow: $data"></tbody>'+
        '<!-- /ko -->'+
        '</table>'+
        '</div>'+
        '</div>'+
        '<div class="kgFooterPanel" data-bind="visible: footerVisible, css: {\'ui-widget-content\': jqueryUITheme, \'ui-corner-bottom\': jqueryUITheme}, style: footerStyle"><div class="kgTotalSelectContainer" data-bind="visible: footerVisible"><div class="kgFooterTotalItems" data-bind="css: {\'kgNoMultiSelect\': !multiSelect}" ><span class="kgLabel">Total Items: <span data-bind="text: maxRowsDisplay"></span></span><span data-bind="visible: filterText().length > 0" class="kgLabel">(Showing: <span data-bind="text: totalFilteredItemsLength"></span>)</span></div><div class="kgFooterSelectedItems" data-bind="visible: multiSelect"><span class="kgLabel">Selected Items: <span data-bind="text: selectedItemCount"></span></span></div></div><div class="kgPagerContainer" style="float: right; margin-top: 10px;" data-bind="visible: (footerVisible && enablePaging), css: {\'kgNoMultiSelect\': !multiSelect}"><div style="float:left; margin-right: 10px;" class="kgRowCountPicker"></div><div style="float:left; margin-right: 10px; line-height:25px;" class="kgPagerControl" style="float: left; min-width: 135px;"><button class="kgPagerButton" data-bind="click: pageToFirst, disable: cantPageBackward()" title="First Page"><div class="kgPagerFirstTriangle"><div class="kgPagerFirstBar"></div></div></button><button class="kgPagerButton" data-bind="click: pageBackward, disable: cantPageBackward()" title="Previous Page"><div class="kgPagerFirstTriangle kgPagerPrevTriangle"></div></button><input class="kgPagerCurrent" type="number" style="width:50px; height: 24px; margin-top: 1px; padding: 0px 4px;" data-bind="value: pagingOptions.currentPage, valueUpdate: \'afterkeydown\'"/><button class="kgPagerButton" data-bind="click: pageForward, disable: cantPageForward()" title="Next Page"><div class="kgPagerLastTriangle kgPagerNextTriangle"></div></button><button class="kgPagerButton" data-bind="click: pageToLast, disable: cantPageForward()" title="Last Page"><div class="kgPagerLastTriangle"><div class="kgPagerLastBar"></div></div></button></div></div></div>';
    };

    /***********************************************
    * FILE: ..\src\templates\headerRowTemplate.html
    ***********************************************/
    window.kg.defaultHeaderRowTemplate = function () { return '<tr data-bind="foreach: visibleColumns"><th data-bind="kgHeaderCell: $data,attr: { \'class\': \'kgHeaderCell \' + \'col\' + $index() }"></th></tr>'; };

    /***********************************************
    * FILE: ..\src\templates\headerCellTemplate.html
    ***********************************************/
    window.kg.defaultHeaderCellTemplate = function () {return '<div data-bind="style: { cursor : sortable() ? \'pointer\' : \'default\' }, click: sort, css: {\'kgSorted\': !noSortVisible }, attr: {\'class\': \'kgHeaderSortColumn \' + headerClass()}"><div data-bind="attr: { \'class\': \' kgHeaderText\' }, html: displayName"></div><div class="kgSortButtonDown" data-bind="visible: showSortButtonDown"></div><div class="kgSortButtonUp" data-bind="visible: showSortButtonUp"></div><div data-bind="visible: resizable, click: gripClick, mouseEvents: { mouseDown: gripOnMouseDown }" class="kgHeaderGrip" ></div></div>';};
    ...
    ***********************************************/
    window.kg.defaultCellTemplate = function () { return '<div data-bind="html: $data.getProperty($parent),attr: { \'class\': \'kgCellText \' + \'colt\' + $index() }"></div>'; };
    ...
    ko.bindingHandlers['koGrid'] = (function () {
        return {
            'init': function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                $('.kgViewport', gridElem).trigger('create'); //#CapLink - we need to apply styling after the grid is created
    ...
    ***********************************************/
    window.kg.Column = function (config, grid) {
        ...
        if (colDef.cellTemplate && !TEMPLATE_REGEXP.test(colDef.cellTemplate)) {
            self.cellTemplate = window.kg.utils.getTemplateText(colDef.cellTemplate);
        }
        if (colDef.headerCellTemplate && !TEMPLATE_REGEXP.test(colDef.headerCellTemplate)) {
            self.headerCellTemplate = window.kg.utils.getTemplateText(colDef.headerCellTemplate);
        }
    ...
    window.kg.RowFactory = function (grid) {
        ...
        self.filteredDataChanged = function () {
            ...
            if (grid.config.groups.length > 0) {
                ...
                if (grid.config.onGroupingCompleted != undefined) {
                    grid.config.onGroupingCompleted();
                }
            }
    ...
    ***********************************************/
    window.kg.Grid = function (options) {
        var defaults = {
            ...
            singleSelectedItem: ko.observable(), //#CapLink: It will hold the single selected item
        ...
        //self vars
        var showSelectionCheckBoxe = true;
        if (options.displaySelectionCheckbox != undefined && options.displaySelectionCheckbox == false) {
            showSelectionCheckBoxe = false;
        }

        self.config = $.extend(defaults, options);
        self.config.displaySelectionCheckbox = showSelectionCheckBoxe; //#CapLink: Forcing the checkbox for selection as do not want the select-on-click row selection
        self.config.selectWithCheckboxOnly = true; //#CapLink: Forcing the checkbox for selection as do not want the select-on-click row selection
        ...
        self.setRenderedRows = function (newRows) {
            ...
            //#CapLink: this is to ensure that the single selected item is reflected after the rows are built
            if(self.singleSelectedItem() != undefined && self.singleSelectedItem() != null){
                self.singleSelectedItemPointer(self.singleSelectedItem());
            }
        };
        ...
        self.buildColumns = function () {
            ...
            if (self.config.displaySelectionCheckbox && self.config.canSelectRows) {
                var defaultHeaderTemplate, headerTemplate;
                defaultHeaderTemplate = '<input class="kgSelectionHeader" type="checkbox" data-bind="visible: $grid.multiSelect, checked: $grid.allSelected"/>'

                if (self.config.selectionBoxHeaderTemplate != undefined) {
                    headerTemplate = window.kg.utils.getTemplateText(self.config.selectionBoxHeaderTemplate);
                }
                else {
        ...
        self.configureColumnWidths = function () {
            ...
            $.each(cols, function (i, col) {
                ...
                if (isNaN(t)) {
                    ...
                    /* Don't need this logic for now, keeping it here for reference
                    else if (t.indexOf('size') != -1) { //#CapLink
                        col.index = i;
                        sizedArray.push(col);} */
                    ...
                    //#CapLink - additional column which is added when groping is turned on needs to be factored in. Not updating the above calculation
                    if (self.config.groups.length > 0) {
                        if (columns[i].field == "dirtyFlag") {
                            columns[i].width = 25; //#CapLink: Hack - the logic below is somehow not working
                        }
                        else if (columns[i].field != "") {
                            var columnMatch = $.grep(cols, function (c) { return c.field == columns[i].field; });

                            if (util.getType(columnMatch[0].width) == "String" && columnMatch[0].width.indexOf('*') != -1) {
                                //Will be calculated down below, might not required any other updates here
                            }
                            else{
                                columns[i].width = columnMatch[0].width;
                            }
                        }

                        totalWidth += parseInt(columns[i].width, 10);
                    }
                    else {
                        totalWidth += parseInt(col.width, 10);
                        columns[i].width = parseInt(col.width, 10);
                    }
                }
            });
            //#CapLink: Sized Columns
            if (sizedArray.length > 0) {
                $.each(sizedArray, function (i, col) {
                        var sizeTag = col.width.replace('*', '')
                        var sizeValue = Helpers.Size.getSize(sizeTag.replace('size.', ''));
                        columns[col.index].width = sizeValue;
                    })
            }
            ...
            if (asterisksArray.length > 0) {
                ...
                //ORIGINAL-> var remainingWidth = self.rootDim.outerWidth() - totalWidth; //#CapLink - updating this logic as the size in the rootDim might not be latest when we are resizing the grids dynamically
                var rootWidth = 0;
                if (self.$root) {
                    rootWidth = self.$root.width();
                }

                if (self.config.groups.length > 0) {
                    totalWidth = totalWidth + 45; //Width of the margin added when grouping is turned on
                }

                var remainingWidth = rootWidth - totalWidth  //#CapLink
                // calculate the weight of each asterisk rounded down
                var asteriskVal = Math.floor(remainingWidth / asteriskNum);
                // set the width of each column based on the number of stars
                $.each(asterisksArray, function (i, col) {
                    //#CapLink - logic for recalculating the column width
                    if (col.width.indexOf('size.') != -1) {
                        var calculatedWidth;
                        if (remainingWidth > 0) {
                            ...
                            var sizeTag = col.width.replace('*', '')
                            var sizeValue = Helpers.Size.getSize(sizeTag.replace('size.',''));
                            calculatedWidth = sizeValue;
                        }

                        if (self.config.groups.length > 0) {
                            var columnMatch = $.grep(columns, function (c) { return c.field == col.field; });
                            columnMatch[0].width = calculatedWidth;
                        }
                        else {
                            columns[col.index].width = calculatedWidth;
                        }
                    }
                    else {
                    ...
                    if (col.index + 1 == numOfCols) {
                        ...
                        if (self.maxCanvasHt() > self.viewportDimHeight()) {
                            ...
                            //offset += window.kg.domUtilityService.ScrollW; //#CapLink: ScrollW isn't calculated correctly, so using the static width instead
                            offset += 17;
                        }
        ...
        if (self.config.rowTemplate && !TEMPLATE_REGEXP.test(self.config.rowTemplate)) {
            self.rowTemplate = window.kg.utils.getTemplateText(self.config.rowTemplate);
        }
        if (self.config.headerRowTemplate && !TEMPLATE_REGEXP.test(self.config.headerRowTemplate)) {
            self.headerRowTemplate = window.kg.utils.getTemplateText(self.config.headerRowTemplate);
        }
        //scope funcs
        ...
        self.maxRows = ko.observable(Math.max(self.config.pagingOptions.totalServerItems() || self.sortedData().length, 0));
        ...
        //#CapLink
        self.setSingleSelectedItem = function(entity){
            var rowItem = null;
            var selectedlength = self.selectedItems().length;
            if (selectedlength > 0) {
                //$.each(self.selectedItems, function(i,item){ item[SELECTED_PROP] = false; });
            ...
            $.each(self.rowFactory.rowCache, function (i, row) {
                if (row && row.selected()) {
                    row.selected(false);
                    row.entity[SELECTED_PROP] = false;
                }
            ...
            if (rowItem == null && self.rowFactory.rowCache.length > 0) {
                rowItem = self.rowFactory.rowCache[0];
                //throw new Error('Not able to locate single selected item in the rows.');
            }

            self.selectionService.lastClickedRow = rowItem;
            self.selectionService.setSelection(rowItem,true);
        };
        self.singleSelectedItem = self.config.singleSelectedItem;

        self.singleSelectedItem.subscribe(function(newVal){
            if(newVal == self.singleSelectedItemPointer()){
                return;
            }

            self.singleSelectedItemPointer(newVal);
        })

        self.singleSelectedItemPointer = ko.computed({
            read: function () {
           ...
           write:function (item){ self.setSingleSelectedItem(item);}
        });

        self.maxPages = ko.computed(function () {
            self.maxRows(Math.max(self.config.pagingOptions.totalServerItems() || self.sortedData().length, 0));
    ...
    window.kg.SelectionService = function (grid) {
        ...
        self.ChangeSelection = function (rowItem, evt) {
            ...
            if (evt && evt.shiftKey && self.multi) {
                ...
                grid.singleSelectedItem(rowItem.entity); //#CapLink
            } else {
