...
***********************************************/
kg.defaultGridTemplate = function(){ return '<table><colgroup><col><col style="width:99px"></colgroup><!-- ko foreach: renderedRows --><tbody data-bind="kgRow: $data"></tbody><!-- /ko --></table>';};
/***********************************************
* FILE: ..\src\templates\rowTemplate.html
***********************************************/
kg.defaultRowTemplate = function(){ return '<tr><!-- ko foreach: $grid.visibleColumns --><td data-bind="kgCell: $data"></td><!-- /ko --></tr>';};

/***********************************************
* FILE: ..\src\templates\cellTemplate.html
***********************************************/
kg.defaultCellTemplate = function(){ return '<span data-bind="html: $data.getProperty($parent)"></span>';};
